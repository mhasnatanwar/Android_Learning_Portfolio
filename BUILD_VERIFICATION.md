...
Verified on 17 September 2026 using Android SDK 35, Gradle 9.5.0, Android Gradle Plugin 9.3.2, and Kotlin/Compose compiler plugin 2.3.10.

| Project | Command | Result |
| --- | --- | --- |
| Module 1 - Profile Card | `gradlew.bat :app:compileDebugKotlin` | Passed |
| Module 2 - Tip Calculator | `gradlew.bat :app:compileDebugKotlin` | Passed |
...
1. Run each app on an emulator or physical device.
